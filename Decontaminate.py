...
def Decontaminate_Values(df_list):
    ...
    for n in range(len(df_list)):
        if n == 0:
            ...
            df_list[n].loc[0, ["Federal_MCL", "Federal_MCLG", "Units"]] = [
                np.nan, np.nan, 'pCi/L']
            df_list[n].loc[1, ["State_MCL", "State_DLR", "State_PHG", "Federal_MCL",
                               "Federal_MCLG", "Units"]] = [20000, 1000, 400, np.nan, np.nan, 'pCi/L']
            ...
            df_list[n].loc[4, ["Contaminant", "Federal_MCL", "Federal_MCLG"]] = [
                '1,1-Dichloroethane (1,1-DCA)', np.nan, np.nan]
            ...
            df_list[n].loc[3, ["Federal_MCLG"]] = [0.0]
            df_list[n].loc[4, ["PHG_Date", "Federal_MCL",
                               "Federal_MCLG"]] = [2006, np.nan, np.nan]
